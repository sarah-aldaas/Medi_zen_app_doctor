  ...
  void _navigateToArticleDetails(NotificationData data, BuildContext context) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), // ArticleDetailsNotificationPage(articleId: data.articleId!),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToAllergyDetails(NotificationData data, BuildContext context) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), //AllergyDetailsPage(allergyId: data.allergyId!),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToReactionDetails(NotificationData data, BuildContext context) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), //ReactionDetailsPacge(allergyId: data.allergyId!, reactionId: data.reactionId!,),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToInvoiceDetails(NotificationData data, BuildContext context) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), // InvoiceDetailsPage(appointmentId: data.appointmentId!,invoiceId: data.invoiceId!,),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToServiceRequestDetails(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), // ServiceRequestDetailsPage(serviceId: data.serviceRequestId!),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToObservationDetails(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), // ObservationDetailsPage(observationId: data.observationId!,serviceId: data.serviceRequestId!,),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToImagingStudyDetails(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), //ImagingStudyDetailsPage(imagingStudyId: data.imagingStudyId!,serviceId: data.serviceRequestId!,),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToConditionDetails(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), //ConditionDetailsPage(conditionId: data.conditionId!),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToMedicationDetails(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), // MedicationDetailsPage(medicationId: data.medicationId!),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToDiagnosticReportDetails(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), // DiagnosticReportDetailsPage(diagnosticReportId: data.diagnosticReportId!),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
  ...
  void _navigateToComplaintDetails(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                Container(), //ComplainDetailsPage(complainId: data.complaintId!),
      ),
    ).then((_) {
      _loadInitialNotifications();
    });
