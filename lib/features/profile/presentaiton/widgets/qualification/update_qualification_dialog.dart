...
void showUpdateQualificationDialog(
        ...
        builder: (context, setState) {
          return FutureBuilder<List<CodeModel>>(
            ...
            builder: (context, snapshot) {
              ...
              if (selectedQualificationType != null &&
                  !qualificationTypes.contains(selectedQualificationType)) {
              ...
              return AlertDialog(
                              ...
                              label: Text(
                                selectedPdfFile != null
                                    ...
                                    : (qualification.pdfFileName ??
                                        'qualificationPage.selectPdf'.tr(
                                          context,
                                        )),
                                style: TextStyle(
                                  color:
                ...
                actions: [
                  ...
                  ElevatedButton(
                            ...
                            : () async {
                              if (issuerController.text.trim().isEmpty ||
                                ...
                                ShowToast.showToastError(
                                  message: 'qualificationPage.requiredFields'
                                      .tr(context),
                                );
                                return;
                              }
                              ...
                              try {
                                ...
                                ShowToast.showToastError(
                                  message:
                                      'qualificationPage.errorUpdatingQualification'
                                          .tr(context),
                                );
                              } finally {
                                setState(() {
                    ...
                    child: Text(
                      'qualificationPage.update'.tr(context),
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 15,
                      ),
