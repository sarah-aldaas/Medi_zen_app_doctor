...
class _EditServiceRequestPageState extends State<EditServiceRequestPage> {
  ...
  bool _isPriorityLoading = true;
  bool _isBodySiteLoading = true;
  bool _isHealthCareLoading = true;
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      final serviceRequest = ServiceRequestModel(
        ...
        serviceRequestCategory: _selectedCategoryId != null
            ? CodeModel(id: _selectedCategoryId!, code: '', display: '', description: '', codeTypeId: '')
            : null,
        serviceRequestPriority: _selectedPriorityId != null
            ? CodeModel(id: _selectedPriorityId!, code: '', display: '', description: '', codeTypeId: '')
            : null,
        serviceRequestBodySite: _selectedBodySiteId != null
            ? CodeModel(id: _selectedBodySiteId!, code: '', display: '', description: '', codeTypeId: '')
            : null,
      ...
      children: [
        ...
        BlocBuilder<CodeTypesCubit, CodeTypesState>(
          builder: (context, state) {
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      context.read<CodeTypesCubit>()
                          .getServiceRequestCategoryCodes(context: context)
            ...
            // Verify the value exists in the loaded codes
      ...
      children: [
        ...
        BlocBuilder<ServiceCubit, ServiceState>(
          builder: (context, state) {
            ...
            if (state is ServiceHealthCareError) {
              return Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      setState(() => _isHealthCareLoading = true);
                      context.read<ServiceCubit>().getAllServiceHealthCare()
                          .then((_) => setState(() => _isHealthCareLoading = false));
                    },
                    child: Text('Retry'),
            ...
            // Verify the value exists in the loaded services
            final validValue = services.any((service) => service.id == _selectedHealthCareServiceId)
                ? _selectedHealthCareServiceId
                : null;

            if (_selectedHealthCareServiceId != null && validValue == null) {
              WidgetsBinding.instance.addPostFrameCallback((_) {
                setState(() => _selectedHealthCareServiceId = null);
              });
            }
  ...
  bool get _isFormLoading => _isCategoryLoading ||
      _isPriorityLoading ||
      _isBodySiteLoading ||
      _isHealthCareLoading;
      ...
      body: BlocConsumer<ServiceRequestCubit, ServiceRequestState>(
        ...
        builder: (context, state) {
          ...
          return AbsorbPointer(
            absorbing: _isFormLoading,
            child: Opacity(
              opacity: _isFormLoading ? 0.5 : 1.0,
                    ...
                    children: [
                      ...
                      Center(
                        child: ElevatedButton(
                          ...
                          child: Text(
                            'editServiceRequest.updateServiceRequest'.tr(context),
                            style: const TextStyle(
