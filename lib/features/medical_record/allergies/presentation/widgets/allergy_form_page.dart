  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.allergy == null
              ? 'allergyFormPage.addAllergyTitle'.tr(context)
              : 'allergyFormPage.editAllergyTitle'.tr(context),
                ...
                children: [
                  TextFormField(
                    ...
                    validator:
                        (value) =>
                            value?.isEmpty ?? true
                                ? 'allergyFormPage.allergyNameRequiredError'.tr(
                                  context,
                                )
                                : null,
                  ),
                  ...
                  _buildCodeDropdown(
                    ...
                    onChanged:
                        (value) =>
                            setState(() => _selectedClinicalStatus = value),
                  ),
                  ...
                  _buildCodeDropdown(
                    ...
                    label: 'allergyFormPage.verificationStatusLabel'.tr(
                      context,
                    ),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'allergyFormPage.lastOccurrenceLabel'.tr(
                        context,
                      ),
                  ...
                  SwitchListTile(
                    title:
                        'allergyFormPage.discoveredDuringEncounterToggle'
                            .tr(context)
                            .text(),
        ...
        if (state is CodeTypesSuccess) {
          ...
          return DropdownButtonFormField<CodeModel>(
            ...
            validator:
                (value) =>
                    value == null
                        ? '$label ${'allergyFormPage.requiredFieldError'.tr(context)}'
                        : null,
          );
        }
