class AllergyEndPoints {
  ...
  static String update({required String patientId, required String allergyId,required String appointmentId}) => "/practitioner/patients/$patientId/allergies/$allergyId";
