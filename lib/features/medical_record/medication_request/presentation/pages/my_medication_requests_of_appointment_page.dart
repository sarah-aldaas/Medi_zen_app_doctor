...
class MyMedicationRequestsOfAppointmentPage extends StatefulWidget {
  ...
  const MyMedicationRequestsOfAppointmentPage({super.key, required this.filter, required this.appointmentId,required this.patientId});
...
class _MyMedicationRequestsOfAppointmentPageState extends State<MyMedicationRequestsOfAppointmentPage> {
  ...
  void _loadInitialMedicationRequests() {
    ...
    context.read<MedicationRequestCubit>().getMedicationRequestsForAppointment(patientId:widget.patientId,context: context, filters: widget.filter.toJson(),appointmentId: widget.appointmentId);
  }
  ...
  void _scrollListener() {
    if (_scrollController.position.pixels == _scrollController.position.maxScrollExtent && !_isLoadingMore) {
      ...
      context
          ...
          .getMedicationRequestsForAppointment(patientId:widget.patientId,filters: widget.filter.toJson(), loadMore: true, context: context,appointmentId: widget.appointmentId)
