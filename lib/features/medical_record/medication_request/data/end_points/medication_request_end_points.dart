class MedicationRequestEndPoints {
  ...
  static String getAllMedicationRequestForAppointment({required String patientId, required String appointmentId}) =>
      "/practitioner/patients/$patientId/appointments/$appointmentId/medication-requests";

  static String getAllMedicationRequestForCondition({required String conditionId, required String patientId}) =>
      "/practitioner/patients/$patientId/conditions/$conditionId/medication-request";
  ...
  static String createMedicationRequest({required String patientId}) => "/practitioner/patients/$patientId/medication-requests";

  static String updateMedicationRequest({required String medicationRequestId, required String patientId}) =>
      "/practitioner/patients/$patientId/medication-requests/$medicationRequestId";

  static String deleteMedicationRequest({required String medicationRequestId, required String patientId}) =>
      "/practitioner/patients/$patientId/medication-requests/$medicationRequestId";
