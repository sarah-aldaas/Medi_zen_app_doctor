...
class CreateDiagnosticReportPage extends StatefulWidget {
  ...
  const CreateDiagnosticReportPage({super.key, required this.patientId, required this.conditionId, required this.appointmentId});
...
class _CreateDiagnosticReportPageState extends State<CreateDiagnosticReportPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("diagnosticReportCreate.createDiagnosticReport".tr(context)),
          ...
          BlocListener<DiagnosticReportCubit, DiagnosticReportState>(
            listener: (context, state) {
              if (state is DiagnosticReportError) {
                ...
                ShowToast.showToastSuccess(message: "diagnosticReportCreate.diagnosticReportCreatedSuccessfully".tr(context));
