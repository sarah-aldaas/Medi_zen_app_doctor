...
class EncounterListOfAppointmentPage extends StatefulWidget {
  ...
  @override
  State<EncounterListOfAppointmentPage> createState() => _EncounterListOfAppointmentPageState();
}

class _EncounterListOfAppointmentPageState extends State<EncounterListOfAppointmentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<EncounterCubit, EncounterState>(
      builder: (context, state) {
        ...
        return Scaffold(
          floatingActionButton: encounters.isEmpty
              ? FloatingActionButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => CreateEditEncounterPage(
                    patientId: widget.patientId,
                    appointmentId: widget.appointmentId,
                  ),
                ),
            ...
            child: const Icon(Icons.add, color: Colors.white),
              ...
              : null, // Hide FAB when encounters exist
  ...
  Widget _buildBody(BuildContext context, EncounterState state, List<EncounterModel?> encounters) {
    final TextTheme textTheme = Theme.of(context).textTheme;
