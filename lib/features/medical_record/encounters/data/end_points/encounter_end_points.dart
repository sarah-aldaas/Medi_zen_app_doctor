class EncounterEndPoints {
  static String forPatient({required String patientId}) =>
  ...
  static String finalize({required int patientId, required int encounterId}) =>
      "/practitioner/patients/$patientId/encounters/$encounterId/final";

  static const String assignService = "/practitioner/assign-service-encounter";

  static const String unassignService =
      "/practitioner/unassign-service-encounter";

  static String appointmentServices({
