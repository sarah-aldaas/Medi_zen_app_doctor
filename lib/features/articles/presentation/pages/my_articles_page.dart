  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          context.pushNamed(AppRouter.addArticle.name); // Update with your route name
        },
                ...
                if (state is ArticleError) {
                  return Center(
                    child: Column(
                      ...
                      children: [Text(state.error), ElevatedButton(onPressed: _loadArticles, child: Text("Retry".tr(context)))],
                    ),
                  );
                }
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            context.pushNamed(AppRouter.updateArticle.name, extra: article);
                          },
                        ),
                        IconButton(
      ...
      builder:
          (context) => AlertDialog(
            ...
            actions: [
              ...
              TextButton(onPressed: () => Navigator.pop(context, true), child: Text("articles.delete.submit".tr(context), style: TextStyle(color: Colors.red))),
            ],
          ),
    );
