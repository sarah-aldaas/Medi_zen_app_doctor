...
class _UpdateArticlePageState extends State<UpdateArticlePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("articles.update.title".tr(context)),
        leading: IconButton(
      ...
      body: BlocConsumer<ArticleCubit, ArticleState>(
        listener: (context, state) {
          if (state is ArticleUpdateSuccess) {
            ShowToast.showToastSuccess(message: "articles.update.success".tr(context));
            ...
            child: Column(
              ...
              children: [
                ...
                if (_imageFile != null) ...[
                  ...
                  const SizedBox(height: 16),
                  Image.network(widget.article.imageUrl!, height: 100, fit: BoxFit.cover),
                ],
                const SizedBox(height: 16),
                ElevatedButton(
